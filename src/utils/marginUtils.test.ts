...
describe('getTierMarginHealth', () => {
  it('returns healthy for margin >= 65', () => {
    expect(getTierMarginHealth(65)).toBe('healthy');
    expect(getTierMarginHealth(80)).toBe('healthy');
  });

  it('returns acceptable for margin 50-64', () => {
    expect(getTierMarginHealth(50)).toBe('acceptable');
    expect(getTierMarginHealth(60)).toBe('acceptable');
  });
